...
class Pipe:
    def __init__(self,x):
        ...
        self.tpipe=pygame.Rect(x,self.gap-400,40,320)
        self.bpipe=pygame.Rect(x,self.gap+100,40,500)
    def display(self):
...
bird1=Bird()
pipe1=Pipe(150)
# Create an object 'pipe2' for 'Pipe' class
...
while True:  
  ...
  pipe1.display()
  pipe1.move()
  # Call the 'display()' method using the 'pipe2' object
  
  # Call the 'move()' method using the 'pipe2' object
